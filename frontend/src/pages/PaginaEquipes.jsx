...
const PaginaEquipes = (props) => {
  ...
  function cancelarCriarEquipe() {
    setCriarEquipeAberto(false);
    setNomeNovaEquipe("");
  }
    ...
    <Container sx={{ display: "flex", mt: "1.5em" }}>
      <Stack width="100%" gap="1em">
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <span>
            <Fab
              onClick={atualizarEquipesUsuario}
              variant="contained"
              color="primary"
              sx={{ m: "0 1em" }}
            >
            ...
            <Fab
              onClick={() => setCriarEquipeAberto(true)}
              variant="contained"
              color="primary"
            >
              <Icon>add</Icon>
      ...
      <Dialog open={criarEquipeAberto} onClose={cancelarCriarEquipe}>
        ...
        <DialogActions>
          ...
          <LoadingButton
            onClick={submitCriarEquipe}
            loading={carregandoCriarEquipe}
            disabled={nomeNovaEquipe.length < 2}
          >
            Criar
          </LoadingButton>
        </DialogActions>
