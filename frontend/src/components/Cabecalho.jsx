...
const Cabecalho = () => {
  ...
  function submitLogout() {
    apiLogout().then(() => setUsuario(null));
  }
      ...
      <Toolbar>
        ...
        <Stack marginLeft="0.75em" spacing="-0.75em" flexGrow="1">
          ...
          <Typography variant="caption">
            Sistema de gerenciamento e apoio para projetos
          </Typography>
        </Stack>
        {usuario && (
          <>
            <div
              onClick={(e) => setAncoraMenuUsuario(e.currentTarget)}
              style={{
                cursor: "pointer",
                display: "flex",
                alignItems: "center",
            ...
            >
              <Typography
                sx={{ mr: "0.5em", fontSize: "1.1em", fontWeight: "bold" }}
              >
                {usuario.nomeDisplay}
              </Typography>
            ...
            <Menu
              anchorEl={ancoraMenuUsuario}
              open={Boolean(ancoraMenuUsuario)}
              onClose={() => setAncoraMenuUsuario(null)}
            >
              <MenuItem
                onClick={() => {
